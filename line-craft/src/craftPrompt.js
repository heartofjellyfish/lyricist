...
const CORE_IDENTITY = [
  ...
  "When a subject is very familiar (sunset, rain, a face), it helps to step around the phrases you've read a hundred times — but only when the swerve earns something. Freshness is the goal, not strangeness.",
  "One option among many: let the speaker's feeling stain a verb or adjective inside an objective scene — the flower 'splashes tears', the light 'refuses' the room. Use sparingly, only when it deepens the image.",
